...
public class AdminFuncionarioBusquedaBean implements Serializable {
    ...
    private String campoBusquedaFuncionario = "";
    ...
    public String getCampoBusquedaFuncionario() {
        return campoBusquedaFuncionario;
    }

    public void setCampoBusquedaFuncionario(String campoBusquedaFuncionario) {
        this.campoBusquedaFuncionario = campoBusquedaFuncionario;
    }
